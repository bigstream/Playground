...
namespace EchoServiceReference
{
    ...
    public interface IEchoService
    {
        ...
        System.Threading.Tasks.Task<string> ComplexEchoAsync(EchoServiceReference.EchoMessage text);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(EchoServiceReference.EchoFault), Action="http://tempuri.org/IEchoService/FailEchoEchoFaultFault", Name="EchoFault", Namespace="http://schemas.datacontract.org/2004/07/CoreWCfDemoServer")]
        System.Threading.Tasks.Task<string> FailEchoAsync(string text);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface IEchoServiceChannel : EchoServiceReference.IEchoService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class EchoServiceClient : System.ServiceModel.ClientBase<EchoServiceReference.IEchoService>, EchoServiceReference.IEchoService
    {
        ...
        public System.Threading.Tasks.Task<string> ComplexEchoAsync(EchoServiceReference.EchoMessage text)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IEchoService))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:54891/EchoService/basichttp");
            }
            if ((endpointConfiguration == EndpointConfiguration.WSHttpBinding_IEchoService))
            {
                return new System.ServiceModel.EndpointAddress("https://localhost:44316/EchoService/WSHttps");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
